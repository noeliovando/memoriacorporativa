...
<header id="header">
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            ['label' => 'Pozos', 'items' => [
                ['label' => 'Pozo', 'url' => ['/pozo']],
                ['label' => 'Campo', 'url' => ['/campo']],
                ['label' => 'Division', 'url' => ['/division']],
                ['label' => 'Unidad Explotacion', 'url' => ['/unidad-explotacion']],

            ]],
            ['label' => 'Expediente', 'url' => ['/expediente']],
            /*['label' => 'Carpetas', 'items' => [
                ['label' => 'Expediente', 'url' => ['/expediente']],
                //['label' => 'SubCarpeta', 'url' => ['/subcarpeta']],
                //['label' => 'Documentos', 'url' => ['/documentos']],
                //['label' => 'Carpeta Registro', 'url' => ['/carpeta-registro']],
...
<footer id="footer" class="mt-auto py-3 bg-light">
    <div class="container">
        <div class="row text-muted">
            <div class="col-md-6 text-center text-md-start">&copy; PDVSA GODD <?= date('Y') ?></div>
    </div>
</footer>
